...
public class Setup_Details extends javax.swing.JPanel {
    ...
    public Setup_Details() {
        ...
        int count = 0;
        //System.out.println("no of disk is  "+no_of_disk);
        while ((strLine = br.readLine()) != null/*&&count<no_of_disk*/)   {
            System.out.println(strLine);
            // Print the content on the console
            String dname;
            while((dname = global_param_str(strLine.substring(2), "dev_name"))==null){
                strLine=br.readLine();
            };
            dev_name[count] = dname;
            br.readLine();
        ...
        br.close();
            ...
            e.printStackTrace();
            //System.out.println("dev_name size "+dev_name.length);
            return;
        }
